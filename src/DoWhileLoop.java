...

{
    ...
    public static void main(String[] args)
    {
        ...
        */
        ...
        Scanner scanner = new Scanner(System.in);
        boolean okay = false;  // boolean variabel initialiseret til false

        while (!okay)  // så længe okay er false, vil løkken fortsætte
        {
            System.out.println("Enter a number as an integer: ");
            if (scanner.hasNextInt())
            {
            ...
            {
                okay = false;
                scanner.next();  // spis det forkerte input
                System.out.println("You did not enter an integer.");
            }
        }
        int number = scanner.nextInt();  // vi kan nu være sikre på, at brugeren har indtastet et heltal
        System.out.println("Thank you!");
